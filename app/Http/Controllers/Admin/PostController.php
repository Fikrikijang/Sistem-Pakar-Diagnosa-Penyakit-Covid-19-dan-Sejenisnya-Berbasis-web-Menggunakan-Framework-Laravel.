...
class PostController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('admin.post.index', compact('post', 'category', 'tags'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect()->route('post.index')->with('status', 'Postingan anda berhasil diupdate');
    }
    ...
    public function destroy($id)
    {
        ...
        return redirect()->back()->with('status', 'Post Berhasil Dihapus (Silahkan cek trashed post)');
    }
