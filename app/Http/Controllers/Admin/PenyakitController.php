...
class PenyakitController extends Controller
{
    ...
    public function index()
    {
        ...
        $gejalas = Gejala::all();
        return view('admin.penyakit.index', compact('penyakit', 'gejalas'));
    }
    ...
    {
        return view('admin.penyakit.detail', compact('penyakit'));
    }

    public function show(Penyakit $penyakit)
    {
        // return view('admin.penyakit.detail');
        // $penyakit = Penyakit::find($penyakit);
    ...
    {
        $gejalas = Gejala::all();
        return view('admin.penyakit.edit', compact('penyakit', 'gejalas'));
    }
