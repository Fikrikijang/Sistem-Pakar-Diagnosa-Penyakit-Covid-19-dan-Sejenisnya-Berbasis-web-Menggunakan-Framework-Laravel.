    ...
    <div class="container">
      <div class="row align-items-center justify-content-center">
        <div class="col-lg-6 text-center mx-auto">
          ...
          <h1 class="heading mb-3">Tabel Penyakit</h1>
        </div>
                  ...
                  <table class="table table-bordered table-striped">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <button type="button" class="badge badge-primary" onclick="show('{{ route('penyakit.show', $penyakit->id) }}')" data-toggle="modal" data-target="#show"><i class="icon-eye"></i></button>
