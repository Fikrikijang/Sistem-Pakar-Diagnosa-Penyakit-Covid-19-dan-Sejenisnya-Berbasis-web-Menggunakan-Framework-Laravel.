					  ...
					  <table class="table table-bordered table-striped">
						...
						<tbody>
							...
							<tr>
								...
								<td>
									<button type="button" class="btn btn-primary btn-sm" onclick="edit('{{ route('post.edit', $hasil->id ) }}')" data-toggle="modal" data-target="#edit"><i class="fa fa-edit"></i></button>

									<button type="button" class="btn btn-danger btn-sm" onclick="$('form[name={{ $hasil->id }}]').submit();"><i class="fa fa-trash"></i></button>

									<form name="{{ $hasil->id }}" method="post" action="{{ route('post.destroy', $hasil->id )}}">
										{{ method_field('delete') }}
										{{ csrf_field() }}
									</form>
